...
# temperature_sensor = navigator.tsys01.TSYS01() # Setting up the sensor and making it connect to the 12c bus
...
def sensor_active_duty():
    ...
    print("The temperature is that was read is " + str(temp_reading))
